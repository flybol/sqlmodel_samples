...
class ORMBase(SQLModel,table=False):
...
class UserRoleLink(SQLModel,table=True):
    ...
    user_id:int|None=Field(default=None,foreign_key="sys_user.id",primary_key=True)
    role_id:int|None=Field(default=None,foreign_key="sys_role.id",primary_key=True)


class RolePermissionLink(SQLModel,table=True):
    __tablename__:str="sys_role_permission_link"
    role_id:int|None=Field(default=None,foreign_key="sys_role.id",primary_key=True)
    permission_id:int|None=Field(default=None,foreign_key="sys_permission.id",primary_key=True)
